...
<body class="!block" style="display: none">
  <div class="container m-auto p-8 text-grey-darkest">
    ...
    <p class="mb-4">
      Example of column spacing from the <a
        href="https://tailwindcss.com/docs/examples/grids/#column-spacing"
        class="text-indigo">documentation.</a
      >
    </p>
    ...
    <div class="mb-8 p-2 w-full flex flex-wrap bg-grey-light">
      <div class="h-16 border-8 w-full md:w-1/2 lg:w-1/4 bg-grey" />
      <div class="h-16 border-8 w-full md:w-1/2 lg:w-1/4 bg-grey" />
      <div class="h-16 border-8 w-full lg:w-1/2 bg-grey" />
    </div>
  </div>
</body>
